...
class Lease(_message.Message):
    ...
    spec: LeaseSpec
    def __init__(self, metadata: _Optional[_Union[_generated_pb2_1.ObjectMeta, _Mapping]] = ..., spec: _Optional[_Union[LeaseSpec, _Mapping]] = ...) -> None: ...
...
class LeaseList(_message.Message):
    ...
    def __init__(self, metadata: _Optional[_Union[_generated_pb2_1.ListMeta, _Mapping]] = ..., items: _Optional[_Iterable[_Union[Lease, _Mapping]]] = ...) -> None: ...
...
class LeaseSpec(_message.Message):
    ...
    acquireTime: _generated_pb2_1.MicroTime
    renewTime: _generated_pb2_1.MicroTime
    leaseTransitions: int
    strategy: str
    preferredHolder: str
    def __init__(self, holderIdentity: _Optional[str] = ..., leaseDurationSeconds: _Optional[int] = ..., acquireTime: _Optional[_Union[_generated_pb2_1.MicroTime, _Mapping]] = ..., renewTime: _Optional[_Union[_generated_pb2_1.MicroTime, _Mapping]] = ..., leaseTransitions: _Optional[int] = ..., strategy: _Optional[str] = ..., preferredHolder: _Optional[str] = ...) -> None: ...
