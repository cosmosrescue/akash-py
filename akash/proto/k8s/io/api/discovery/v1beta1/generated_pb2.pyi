...
class Endpoint(_message.Message):
    __slots__ = ("addresses", "conditions", "hostname", "targetRef", "topology", "nodeName", "hints")
    class TopologyEntry(_message.Message):
        __slots__ = ("key", "value")
    ...
    topology: _containers.ScalarMap[str, str]
    nodeName: str
    hints: EndpointHints
    def __init__(self, addresses: _Optional[_Iterable[str]] = ..., conditions: _Optional[_Union[EndpointConditions, _Mapping]] = ..., hostname: _Optional[str] = ..., targetRef: _Optional[_Union[_generated_pb2.ObjectReference, _Mapping]] = ..., topology: _Optional[_Mapping[str, str]] = ..., nodeName: _Optional[str] = ..., hints: _Optional[_Union[EndpointHints, _Mapping]] = ...) -> None: ...
