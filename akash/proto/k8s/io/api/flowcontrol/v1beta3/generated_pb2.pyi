...
class LimitedPriorityLevelConfiguration(_message.Message):
    __slots__ = ("nominalConcurrencyShares", "limitResponse", "lendablePercent", "borrowingLimitPercent")
    NOMINALCONCURRENCYSHARES_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, nominalConcurrencyShares: _Optional[int] = ..., limitResponse: _Optional[_Union[LimitResponse, _Mapping]] = ..., lendablePercent: _Optional[int] = ..., borrowingLimitPercent: _Optional[int] = ...) -> None: ...
